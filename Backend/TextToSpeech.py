...
AssistantVoice = env_vars.get("AssistantVoice")  # Get the AssistantVoice from the environmentYou
        ...
        try:
            ...
            print(f"Error in TTS: {e}")
             ...
             try:
               ...
               print(f"Error in the final block: {e} ")
...
if __name__ == "__main__":
    while True:
        ...
        TextToSpeech(input("Enter the prompt: "))
